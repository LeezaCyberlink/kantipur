...
<div class="uk-inline uk-inner-banner">
    ...
    <div class="uk-overlay uk-overlay-primary uk-position-cover uk-banner-overlay uk-flex uk-flex-column uk-flex-center">
        <div class=" uk-width-1-1 uk-text-center" uk-scrollspy=" cls: uk-animation-slide-bottom-small; target: h3, h1;  delay: 400; repeat: false;">
            ...
            <h1 class="uk-margin-small-bottom-top">Contact</h1>
        </div>
    </div>
</div>
<!--------------------------- banner section end ------------------------------------->
<section class="uk-section">
    <div class="uk-container uk-container-large" uk-scrollspy=" cls: uk-animation-slide-bottom-small; target:  .block;  delay: 500; repeat: false;">
        <div class="uk-container  uk-margin-bottom border-rounded block">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5587.017491661533!2d85.627995!3d27.641364!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eba7e5da251f8b%3A0x94616c285a8191b6!2sKantipur%20Pharmaceuticals%20Lab%20Pvt.%20Ltd.!5e1!3m2!1sen!2snp!4v1758607652267!5m2!1sen!2snp" width="100%" height="350" style="border-radius:15px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
                        ...
                        <div class=" uk-child-width-1-2@s uk-grid">
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-form-controls">
                                    <input class="uk-input" id="firstnameform-stacked-text" type="text">
                                </div>
                            </div>
                            <div class="uk-margin-top">
                                <label class="uk-form-label uk-text-bold" for="lastname">Last Name</label>
                                <div class="uk-form-controls">
                                    <input class="uk-input" id="lastname" type="text">
                                </div>
                            </div>
                            <div class="uk-margin-top">
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-form-controls">
                                    <input class="uk-input" id="contact" type="number">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="uk-grid uk-grid-collapse  uk-margin-bottom">
                                ...
                                <div class="uk-width-5-6">
                                    ...
                                    <p class="uk-margin-remove">+977-01-5186604, +977-01-5186602</p>
                                </div>
                            </div>
                            <div class="uk-grid uk-grid-collapse  uk-margin-bottom">
                                <div class="uk-width-1-6 uk-flex uk-flex-center">
                                ...
                                <div class="uk-width-5-6">
                                    ...
                                    <p class="uk-margin-remove">info@kantipurpharma.com</p>
                                </div>
                            </div>
                            <div class="uk-grid uk-grid-collapse  uk-margin-bottom">
                                <div class="uk-width-1-6 uk-flex uk-flex-center">
                                ...
                                <div class="uk-width-5-6">
                                    ...
                                    <p class="uk-margin-remove"> <b>Corporate Office :-</b> <br>
                                        KVD Complex 6th Floor, Balkumari, Lalitpur, Nepal, PIN 44700 <br>
                                        <b>Factory :-</b> <br>
                                        Panchkhal - 06, Hokshe, Kavre
                                    </p>
                                </div>
                            </div>
                        </div>
