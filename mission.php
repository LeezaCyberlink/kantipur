...
<div class="uk-inline uk-inner-banner">
    ...
    <div class="uk-overlay uk-overlay-primary uk-position-cover uk-banner-overlay uk-flex uk-flex-column uk-flex-center">
        <div class=" uk-width-1-1 uk-text-center" uk-scrollspy=" cls: uk-animation-slide-bottom-small; target: h3,h1;  delay: 400; repeat: false;">
            ...
            <h1 class="uk-margin-small-top">Mission and vision</h1>
        </div>
    </div>
</div>
<!--------------------------- banner section end ------------------------------------->
...
<section class="uk-section">
    ...
    <div class="uk-child-width-1-3@l uk-child-width-1-2@m uk-child-width-1-1 uk-grid uk-grid-small uk-grid-match uk-margin-large-top">
        <div>
            <div class="border-rounded border-full uk-padding-small h-300 uk-flex uk-flex-middle uk-flex-center">
                <div class="uk-text-center">
                    <img src="assets/img/icon/mission.png" loading="lazy" width="60" height="60" alt="">
            ...
            <div class=" uk-flex uk-flex-middle uk-flex-center">
                <div class="primary-circle">
                    <img src="assets/img/icon/cow.png" height="50" width="50" alt="">
                </div>
            </div>
        </div>
        <div>
            <div class="border-rounded uk-inline-clip uk-transition-toggle h-300" tabindex="0">
                <img src="assets/img/commit/img1.jpg" class="border-rounded uk-transition-scale-up uk-transition-opaque" style="height:100%; width:100%; object-fit:cover;">
            </div>
        </div>
        <div>
            <div class="border-rounded border-full uk-padding-small h-300 border-rounded border-full uk-padding-small h-300 uk-flex uk-flex-middle uk-flex-center">
                <div class="uk-text-center">
                    <img src="assets/img/icon/goal.png" loading="lazy" width="60" height="60" alt="">
            ...
            <div class=" uk-flex uk-flex-middle uk-flex-center">
                <div class="primary-circle">
                    <img src="assets/img/icon/buffalo.png" height="50" width="50" alt="">
                </div>
            </div>
        </div>
        <div class="uk-margin-small-bottom">
            <div class="border-rounded uk-inline-clip uk-transition-toggle h-300" tabindex="0">
                <img src="assets/img/commit/img3.jpg" class="border-rounded uk-transition-scale-up uk-transition-opaque" style="height:100%; width:100%; object-fit:cover;">
            </div>
        </div>
        <div class="uk-margin-small-bottom">
            <div class=" uk-flex uk-flex-middle uk-flex-center uk-visible@l">
                <div class="secondary-circle">
                    <img src="assets/img/icon/pig.png" height="50" width="50" alt="">
                </div>
            </div>
            <div class="border-rounded border-full uk-padding-small h-300 border-rounded border-full uk-padding-small h-300 uk-flex uk-flex-middle uk-flex-center">
                <div class="uk-text-center">
                    <img src="assets/img/icon/vision.png" loading="lazy" width="60" height="60" alt="">
        ...
        <div class="uk-margin-small-bottom">
            <div class="border-rounded uk-inline-clip uk-transition-toggle h-300" tabindex="0">
                <img src="assets/img/commit/img4.jpg" class="border-rounded uk-transition-scale-up uk-transition-opaque" style="height:100%; width:100%; object-fit:cover;">
            </div>
        </div>
    </div>
    </div>
