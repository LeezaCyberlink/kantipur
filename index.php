...
<!--------------------------- banner section end ------------------------------------->
<section class="uk-homepage-banner" uk-height-viewport>
            ...
            <div class="uk-width-2-3@m">
                <div>
                    ...
                    <div class="uk-child-width-1-3@m uk-grid-small uk-grid uk-margin-top ">
                        <div class="uk-grid uk-grid-collapse uk-padding-small uk-padding-remove-top uk-padding-remove-bottom ">
                            <div class="uk-width-1-4"><img src="assets/img/icon/mission.png" loading="lazy" height="60" width="60" alt=""></div>
                            <div class="uk-width-3-4">
                                ...
                                <a href="#" class="uk-know-btn"> Know More <span uk-icon="icon:  triangle-right"></span></a>
                            </div>
                        </div>

                        <div class="uk-grid uk-grid-collapse border-left uk-padding-small uk-padding-remove-top uk-padding-remove-bottom">
                            <div class="uk-width-1-4"><img src="assets/img/icon/vision.png" loading="lazy" height="60" width="60" alt=""></div>
                            <div class="uk-width-3-4">
                        ...
                        <div class="uk-grid uk-grid-collapse border-left uk-padding-small uk-padding-remove-top uk-padding-remove-bottom">
                            <div class="uk-width-1-4"><img src="assets/img/icon/goal.png" loading="lazy" height="60" width="60" alt=""></div>
                            <div class="uk-width-3-4">
    ...
    <div class="uk-container">
        ...
        <div uk-slider="autoplay: true; autoplay-interval: 2000">
            <div class="uk-position-relative uk-visible-toggle " tabindex="-1">
                <div class="uk-slider-items uk-child-width-1-2 uk-child-width-1-3@m uk-child-width-1-5@l uk-grid uk-grid-small">
                    <!--  -->
                    <div>
                        <div class="uk-commit-img uk-flex uk-flex-center uk-margin-small-bottom">
                            <img src="assets/img/commit/img1.jpg" loading="lazy" width="400" height="600" alt="">
                        </div>
                    ...
                    <div>
                        <div class="uk-commit-img uk-flex uk-flex-center uk-margin-small-bottom">
                            <img src="assets/img/commit/img2.jpg" loading="lazy" width="400" height="600" alt="">
                        </div>
                        <div class="uk-text-center uk-commit-text">
                    ...
                    <div>
                        <div class="uk-commit-img uk-flex uk-flex-center uk-margin-small-bottom">
                            <img src="assets/img/commit/img3.jpg" loading="lazy" width="400" height="600" alt="">
                        </div>
                        <div class="uk-text-center uk-commit-text">
                    ...
                    <div>
                        <div class="uk-commit-img uk-flex uk-flex-center uk-margin-small-bottom">
                            <img src="assets/img/commit/img4.jpg" loading="lazy" width="400" height="600" alt="">
                        </div>
                        <div class="uk-text-center uk-commit-text">
        ...
        <div class="uk-grid">
            <div class="uk-width-1-3@m">
                <div>
                    ...
                    <div class="uk-270">
                        <img src="assets/img/commit.jpg" class="border-rounded" loading="lazy" height="500" width="500" alt="">
                    </div>
                </div>
            </div>
            <div class="uk-width-2-3@m">
...
<!--------------------------- video section start ------------------------------------->
<div class="uk-container uk-container-large uk-video-section  uk-margin-large-bottom">
    <iframe
...
<section class="uk-vision-section uk-section ">
    <div class="uk-container uk-container-large">
        ...
        <div class="uk-child-width-1-2@m" uk-grid uk-height-match=".same-height">
            <div>
                <img src="assets/img/team.png" alt="" loading="lazy" class="border-rounded same-height uk-img-cover">
            </div>
        ...
        <div class="uk-margin-top uk-flex uk-flex-center">
            <a href="#" class="uk-button uk-white-btn uk-border-pill">
                <div class="uk-flex uk-flex-middle uk-flex-center" style="gap:10px;">
                    <span class="uk-btn-text">EXPLORE MORE</span>
                    <span class="uk-btn-icon">
                        <i class="fa-solid fa-paw"></i>
    ...
    <div class="uk-container uk-container-large">
        ...
        <div class="uk-child-width-1-2@m" uk-grid>
            <div>
                <div>
                    <a href="#">
                        <img src="assets/img/blog1.png" class="uk-blog-section-img" loading="lazy" alt="">
                    </a>
                </div>
            ...
            <div>
                <div class="uk-bg-light border-rounded uk-margin-bottom">
                    <div class="uk-grid uk-grid-small ">
                        <div class="uk-width-1-3">
                            <a href="#">
                                <img src="assets/img/blog2.webp" class="uk-blog-small-img" loading="lazy" alt="">
                            </a>
                        </div>
                ...
                <div class="uk-bg-light border-rounded uk-margin-bottom">
                    <div class="uk-grid uk-grid-small ">
                        <div class="uk-width-1-3">
                            <a href="#">
                                <img src="assets/img/blog3.jpeg" class="uk-blog-small-img" loading="lazy" alt="">
                            </a>
                        </div>
                        <div class="uk-width-2-3 uk-flex uk-flex-column uk-flex-center">
                            <div class="uk-flex" style="gap:15px;">
                ...
                <div class="uk-bg-light border-rounded uk-margin-bottom">
                    <div class="uk-grid uk-grid-small ">
                        <div class="uk-width-1-3">
                            <a href="#">
                                <img src="assets/img/blog4.jpeg" class="uk-blog-small-img" loading="lazy" alt="">
                            </a>
                        </div>
                        <div class="uk-width-2-3 uk-flex uk-flex-column uk-flex-center">
                            <div class="uk-flex" style="gap:15px;">
